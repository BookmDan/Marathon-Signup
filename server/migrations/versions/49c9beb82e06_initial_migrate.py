...
Revision ID: 49c9beb82e06
Revises: 
Create Date: 2024-03-23 12:34:28.167469
...
def upgrade():
    ...
    sa.ForeignKeyConstraint(['race_event_id'], ['race_events.id'], name=op.f('fk_follows_race_event_id_race_events')),
