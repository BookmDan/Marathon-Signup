...
function AppNavbar() {
  return (
    <Navbar bg="light" expand="lg">
      <Navbar.Brand as={Link} to="/">Race App</Navbar.Brand>
      ...
      <Navbar.Collapse id="basic-navbar-nav">
        <Nav className="mr-auto">
          ...
          <NavDropdown title="More" id="basic-nav-dropdown">
            ...
            <NavDropdown.Item as={Link} to="/refund-policy">Refund Policy</NavDropdown.Item>
            <NavDropdown.Item as={Link} to="/directions">Directions</NavDropdown.Item>
          </NavDropdown>
        </Nav>
      </Navbar.Collapse>
    </Navbar>
